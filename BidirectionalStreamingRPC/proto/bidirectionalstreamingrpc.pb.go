...
// source: proto/bidirectionalstreamingrpc.proto
...
func (*HelloRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_f129c0e871872ae4, []int{0}
}
...
func (*HelloReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_f129c0e871872ae4, []int{1}
}
...
func init() {
	proto.RegisterType((*HelloRequest)(nil), "BidirectionalStreamingRPC.HelloRequest")
	proto.RegisterType((*HelloReply)(nil), "BidirectionalStreamingRPC.HelloReply")
}

func init() {
	proto.RegisterFile("proto/bidirectionalstreamingrpc.proto", fileDescriptor_f129c0e871872ae4)
}

var fileDescriptor_f129c0e871872ae4 = []byte{
	// 177 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x52, 0x2d, 0x28, 0xca, 0x2f,
	0xc9, 0xd7, 0x4f, 0xca, 0x4c, 0xc9, 0x2c, 0x4a, 0x4d, 0x2e, 0xc9, 0xcc, 0xcf, 0x4b, 0xcc, 0x29,
	0x2e, 0x29, 0x4a, 0x4d, 0xcc, 0xcd, 0xcc, 0x4b, 0x2f, 0x2a, 0x48, 0xd6, 0x03, 0xcb, 0x0b, 0x49,
	0x3a, 0x21, 0x2b, 0x08, 0x86, 0x29, 0x08, 0x0a, 0x70, 0x56, 0x52, 0xe2, 0xe2, 0xf1, 0x48, 0xcd,
	...
	0x5c, 0xa3, 0x6c, 0x2e, 0x76, 0xf7, 0xa2, 0xd4, 0xd4, 0x92, 0xd4, 0x22, 0xa1, 0x04, 0x2e, 0x8e,
	0xe0, 0xc4, 0xca, 0xa0, 0xfc, 0xd2, 0x92, 0x54, 0x21, 0x75, 0x3d, 0x9c, 0xd6, 0xeb, 0x21, 0xdb,
	0x2d, 0xa5, 0x4a, 0x58, 0x61, 0x41, 0x4e, 0xa5, 0x12, 0x83, 0x06, 0xa3, 0x01, 0x63, 0x12, 0x1b,
	0xd8, 0x6b, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0x00, 0x3f, 0x92, 0xe6, 0x03, 0x01, 0x00,
	0x00,
}
...
func (c *greeterClient) SayRoute(ctx context.Context, opts ...grpc.CallOption) (Greeter_SayRouteClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Greeter_serviceDesc.Streams[0], "/BidirectionalStreamingRPC.Greeter/SayRoute", opts...)
	if err != nil {
		return nil, err
	}
...
var _Greeter_serviceDesc = grpc.ServiceDesc{
	ServiceName: "BidirectionalStreamingRPC.Greeter",
	...
	Metadata: "proto/bidirectionalstreamingrpc.proto",
}
